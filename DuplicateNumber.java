...
public class DuplicateNumber {
	...
	public static void findDuplicate(int[] a, int[] adup) {
		...
		if (a.length != 10 || adup.length != 11) {
			System.err.println("error - first array must be length 10 and second array must be length 11");
			return;
		}
		...
		System.out.println("The duplicate number in the second array is " + (sum2 - sum1) + ".");
	}
