...
import Datagram.threads.DatagramServer;
...
public class DatagramUI implements ActionListener, WindowListener {
	...
	private JButton buttonSend, buttonExit;  
	private int port;
	...
	public void createUI() {
		...
		textServerIp = new JTextField("127.0.0.1",12);
		...
		layout.putConstraint(SpringLayout.NORTH, buttonExit, 10, SpringLayout.SOUTH, textScrollPane);
		layout.putConstraint(SpringLayout.WEST, buttonExit, 0, SpringLayout.WEST, textScrollPane);	
	...
	public JLabel getLabelMessages() {
		return labelMessages;
	}

	public void setLabelMessages(JLabel labelMessages) {
